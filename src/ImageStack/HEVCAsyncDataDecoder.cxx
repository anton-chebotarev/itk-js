...
namespace itkjs
  ...
  namespace ImageStack
    ...
    void HEVCAsyncDataDecoder::DecodeData(const Header& i_header, void* ip_data_buffer, unsigned i_data_buffer_size) const
      {
      //std::thread(&HEVCAsyncDataDecoder::_DecodeData, this, i_header, ip_data_buffer, i_data_buffer_size).detach();
      _DecodeData(i_header, ip_data_buffer, i_data_buffer_size);
      }
      
    void HEVCAsyncDataDecoder::_DecodeData(const Header& i_header, void* ip_data_buffer, unsigned i_data_buffer_size) const
      {
      try
        {
